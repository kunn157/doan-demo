		...
		return (
			<div>
				{this.state.askForUsername === true ?
					<div>
						<div className="Join">
							<p style={{ margin: 0, fontWeight: "bold", fontSize:"20px", color:"white" }}>👨‍👨‍👧‍👦𝐄𝐧𝐭𝐞𝐫 𝐔𝐬𝐞𝐫 𝐍𝐚𝐦𝐞 👨‍👨‍👧‍👦</p>
							⌨ <Input id="IP2" placeholder="Username" value={this.state.username} onChange={e => this.handleUsername(e)} />
							<Button id="BtnJoin" variant="contained" color="primary" onClick={this.connect} style={{ margin: "20px" }}>𝐉𝐨𝐢𝐧</Button>
						</div>

						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								borderStyle: "solid",borderColor: "#bdbdbd",objectFit: "fill",width: "37%",height: "25%"}}></video>
						</div>
